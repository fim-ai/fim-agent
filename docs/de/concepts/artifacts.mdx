...
Artefakte werden im Server-Dateisystem gespeichert, ein Verzeichnis pro Unterhaltung. Jedes Artefakt erhält einen UUID-basierten Dateinamen, wodurch URLs ohne Zugriff auf die Unterhaltung nicht zu erraten sind. Dateien werden direkt bereitgestellt – es gibt keine Datenbankdatensätze für einzelne Artefakte, was die Speicherschicht einfach und schnell hält.
