...
- **On-demand tool loading** — When tool selection filters the available set, a `request_tools` meta-tool lets the agent dynamically load additional tools mid-conversation instead of being stuck with the initial selection.
