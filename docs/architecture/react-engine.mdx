...
When the agent has used at least one tool and decides to produce a final answer, a one-time verification prompt is injected before the answer is accepted:
