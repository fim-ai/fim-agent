...
|---|---|---|---|
| 0 | Locale-edit guard | Any staged file under `messages/{locale}/`, `docs/{locale}/`, or `README.{locale}.md` | Aborts the commit. Override: `ALLOW_LOCALE_EDIT=1 git commit ...` |
...
Other locale files (`messages/zh/`, `docs/zh/`, `README.zh.md`, etc.) are **auto-generated** and the pre-commit hook refuses commits that manually edit them. If you need to hand-fix a translation, override once with `ALLOW_LOCALE_EDIT=1 git commit ...` and note the reason in your PR.
