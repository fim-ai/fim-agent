...
<Steps>
  <Step title="Exécution de l'agent">
    ...
    Produit : **réponse**, **latence**, **utilisation de tokens**.
  </Step>
  ...
  <Step title="Persistance et agrégation">
    Chaque résultat de cas est enregistré dans la base de données. Après la fin de tous les cas : **taux de réussite**, **latence moyenne**, **tokens totaux** sont calculés et attachés à l'exécution.
  </Step>
</Steps>
