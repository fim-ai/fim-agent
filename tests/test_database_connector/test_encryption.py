...
def _set_jwt_secret(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import fim_one.core.security.encryption as enc_mod
...
class TestEncryptDecryptField:
    ...
    def test_roundtrip(self) -> None:
        from fim_one.core.security.encryption import decrypt_field, encrypt_field
    ...
    def test_different_ciphertexts(self) -> None:
        ...
        from fim_one.core.security.encryption import encrypt_field
