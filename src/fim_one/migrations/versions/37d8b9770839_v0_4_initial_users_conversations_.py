...
def upgrade() -> None:
    ...
    if not index_exists(bind, "agents", "ix_agents_user_id"):
    ...
    if not index_exists(bind, "conversations", "ix_conversations_user_id"):
        op.create_index(op.f('ix_conversations_user_id'), 'conversations', ['user_id'], unique=False)

    if not table_exists(bind, "messages"):
    ...
    if not index_exists(bind, "messages", "ix_messages_conversation_id"):
