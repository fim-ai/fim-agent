...
def upgrade() -> None:
    ...
    if not table_exists(bind, "email_verifications"):
        op.create_table(
            "email_verifications",
    ...
    if not table_exists(bind, "invite_codes"):
        op.create_table(
            "invite_codes",
            sa.Column("id", sa.String(36), primary_key=True),
    ...
    if not table_exists(bind, "api_keys"):
        op.create_table(
            "api_keys",
            sa.Column("id", sa.String(36), primary_key=True),
    ...
    if not table_exists(bind, "sensitive_words"):
        op.create_table(
            "sensitive_words",
            sa.Column("id", sa.String(36), primary_key=True),
    ...
    if not table_exists(bind, "ip_rules"):
        op.create_table(
            "ip_rules",
            sa.Column("id", sa.String(36), primary_key=True),
    ...
    if not table_exists(bind, "login_history"):
        op.create_table(
            "login_history",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("user_id", sa.String(36), nullable=True, index=True),
    ...
    if not table_exists(bind, "knowledge_bases"):
        op.create_table(
            "knowledge_bases",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("user_id", sa.String(36), sa.ForeignKey("users.id"), nullable=False, index=True),
    ...
    if not table_exists(bind, "mcp_servers"):
        op.create_table(
            "mcp_servers",
            sa.Column("id", sa.String(36), primary_key=True),
    ...
    if not table_exists(bind, "user_oauth_bindings"):
        op.create_table(
            "user_oauth_bindings",
            sa.Column("id", sa.String(36), primary_key=True),
    ...
    if not table_exists(bind, "connector_actions"):
        op.create_table(
            "connector_actions",
            sa.Column("id", sa.String(36), primary_key=True),
    ...
    if not table_exists(bind, "kb_documents"):
        op.create_table(
            "kb_documents",
            sa.Column("id", sa.String(36), primary_key=True),
